                ...
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Chair list</h3>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('admin/table_edit/') . $key['table_id'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                <a href="<?= site_url('admin/table_edit/') . $key['table_id'] ?>" class="btn btn-sm btn-success" onclick=""><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
